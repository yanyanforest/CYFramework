...
- (UIView *)inBorderForColor:(UIColor *)color borderWidth:(CGFloat)borderWidth borderType:(UIBorderSideType)borderType
{
    ...
    if (borderType & UIBorderSideTypeRight) {
        /// 右侧线路径
        [self.layer addSublayer:[self addLineOriginPoint:CGPointMake(self.frame.size.width-borderWidth, 0.0f) toPoint:CGPointMake( self.frame.size.width-borderWidth, self.frame.size.height) color:color borderWidth:borderWidth]];
    }
    ...
    if (borderType & UIBorderSideTypeBottom) {
        /// bottom线路径
        [self.layer addSublayer:[self addLineOriginPoint:CGPointMake(0.0f, self.frame.size.height-borderWidth) toPoint:CGPointMake( self.frame.size.width, self.frame.size.height-borderWidth) color:color borderWidth:borderWidth]];
    }
